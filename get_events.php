...
$sql = "SELECT id, event_name, department, event_date, event_time, venue, ticket_price, total_tickets, available_tickets, has_seating, description FROM events ORDER BY event_date ASC, event_time ASC";
